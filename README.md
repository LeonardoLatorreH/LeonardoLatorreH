...
<p align="center">
<b>Analista de Datos</b> • <b>Business Intelligence</b> • <b>Data Engineering</b> • <b>Infraestructura y Seguridad de Datos</b>
</p>

<p align="center">
<img src="https://img.shields.io/badge/Ubicación-Lima,_Perú-blue?style=flat-square"/>
<img src="https://img.shields.io/badge/Estado-Disponible_para_oportunidades-brightgreen?style=flat-square"/>
</p>

<p align="center">
Analista de Datos Junior con formación en Ingeniería de Software, enfocado en Business Intelligence, Data Integration y Data Engineering. Trabajo estructurando y transformando información para convertirla en indicadores útiles que respalden decisiones reales del negocio. Desarrollo dashboards en Power BI, modelo datos con SQL y automatizo flujos de datos con Python, incluyendo integración y orquestación de pipelines en entornos cloud. Cuento también con experiencia en Soporte TI y Ciberseguridad, lo que me permite entender de forma integral la infraestructura sobre la que se construyen y protegen los datos.
</p>
...
- **Ingeniería de Software e IA:** diseño y desarrollo de aplicaciones, APIs e integración de Inteligencia Artificial mediante arquitecturas modernas y buenas prácticas de desarrollo.

- **Cloud & DevOps:** implementación de servicios cloud, contenedores, automatización y despliegue continuo para aplicaciones y plataformas de datos.

- **Infraestructura y Ciberseguridad:** administración de sistemas, redes, virtualización y aplicación de controles de seguridad para garantizar disponibilidad, integridad y protección de la información.
